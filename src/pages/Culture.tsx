    ...
    <div className="">
      <div className="container overflow-hidden mx-auto flex items-center justify-center">
        <div className='w-full'>
          <HeroPages title={"Culture"} desc={"Attirez et fidélisez les meilleurs talents avec cette vidéo qui mettra en avant vos équipes et véhiculera votre culture d’entreprise."}/>
          <div className='flex flex-col gap-y-[40px] border-b-[1px] border-white/20 py-[40px]'>
            <Description title='Les dernières vidéos "Culture"' desc='Inspirez vous des meilleurs exemples.' />
            <div className=''>
              0 video
            </div>
          </div>
